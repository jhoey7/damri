...
function change_password()
	...
	function create_user()
        ...
        //$this->form_validation->set_rules('password', 'Password', 'required' . $this->config->item('min_password_length', 'ion_auth') . ']|max_length[' . $this->config->item('max_password_length', 'ion_auth') . ']|matches[confirmPassword]');
        $this->form_validation->set_rules('confirmPassword', 'Confirm Password', 'required');
            ...
            $additional_data = array(
                ...
                'id_counter'   => $this->input->post('counter'),
                'pass_counter' => md5($this->input->post('password')),
                'created_at' => $date
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data))
        {
                ...
                //$this->session->set_flashdata('message', $this->ion_auth->messages());
                //redirect(base_url()."index.php/account/login", 'refresh');
        }
      /* else
        {
           ...
           $this->data['message'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
            ...
            $this->data['birthday'] = $this->form_validation->set_value('bday');
            ...
            $this->data['confirmPassword'] = $this->form_validation->set_value('confirmPassword');
		...
		$this->data['kota'] = $this->member_model->getMasterFilter('master_kokab',array('provinsi_id' => '12'),'name','asc');
            ...
            {
                $this->session->set_flashdata('message', $this->ion_auth->messages());
                redirect(base_url()."index.php/account/register/member", 'refresh');
            }
            else
            {
                $this->session->set_flashdata('message', $this->ion_auth->messages());
                redirect(base_url()."index.php/account/register", 'refresh');
            }
                show('account/register', $data ,$this->template_login);
        }*/
    }
