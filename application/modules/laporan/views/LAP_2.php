            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-2">
                    ...
                    <div class="input-group">
                    <select  class="form-control" name="trayek" id="trayek">
                      <option value="0">SEMUA</option>
                      <?php foreach($tr->result_array() as $r) { ?>
                      <option value="<?php echo $r['id_trayek'];?>"><?php echo $r['nama_trayek'];?></option>
                      <?php } ?>
                  </select>
                    </div>
                </div>
                <div class="col-xs-2">
                    ...
                    <select  class="form-control" name="terminal" id="terminal">
                      <option value="0">SEMUA</option>
                      <?php foreach($jur->result_array() as $r) { ?>
                ...
                <div class="col-xs-10">
                    <br/>
                        <button type="button" class="btn btn-primary" onclick="tampilkan_lp2()"><i class="fa fa-send"></i> Tampilkan </button>
                </div>
                </div>
            </div>
        </form>
