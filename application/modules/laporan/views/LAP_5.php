        ...
        <form id="laporan_ak13" name="laporan_ak13" class="form-horizontal" method="post" action="index.php/laporan/save_ap1" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-2">
                    <label class="label-form">Pool Group</label>
                    <div class="input-group">
                    <select  class="form-control" name="group" id="group">
                      <option value="0">SEMUA</option>
                      <?php foreach($dk->result_array() as $r) { ?>
                ...
                <div class="col-xs-10">
                    <br/>
                        <button type="button" class="btn btn-primary" onclick="tampilkan_lp5()"><i class="fa fa-send"></i> Tampilkan </button>
                </div>
                </div>
            </div>
        </form>
