            ...
            ?>
               ...
               <?php $no++; }} ?>
                ...
                <center><b>SUB TOTAL</b></center>
                        ...
                        <?php   foreach($trayek->result_array() as $r) {
                                $subttl = $this->laporan_model->sum_lap2_bawah($this->uri->segment(3),$this->uri->segment(4),$r['id_trayek'],$trmnl,"0","total");
                                $subqty = $this->laporan_model->sum_lap2_bawah($this->uri->segment(3),$this->uri->segment(4),$r['id_trayek'],$trmnl,"0","qty");
                        ?>
                    <td>
                ...
                <br/><br/>
                <div class="col-xs-10">
                <button type="button" class="btn btn-primary" onclick="cetak_lap2()"><i class="fa fa-send"></i> Cetak </button>
                </div>
            </div>
